        ...
        >
          <SwiperSlide>
            <div>
              ...
              <img className='weaponImg img-1' src={riflesImg} alt="imagem do rifle" />
              <p>2,700</p>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div>
              ...
              <img className='weaponImg img-2' src={smgsImg} alt="Icone da habilidade blade storm" />
              <p>1,600</p>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div>
              ...
              <img className='weaponImg img-3' src={sidearmImg} alt="Icone da habilidade blade storm" />
